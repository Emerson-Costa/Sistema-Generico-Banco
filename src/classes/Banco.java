...
public class Banco{
    ...
    public void gerarRelatorios(  ){
        ...
        ComparadorAgencia comparaAgencia= new ComparadorAgencia();//Compara todas as agencias em relacao ao numero da agencia
        Collections.sort(agencias,comparaAgencia);//Ordena em relacao ao numero da agencia
        
        ComparadorConta comparaConta =new ComparadorConta("NUMERO");//Compara todas as contas em relacao ao numero da conta
        for(int i = 0 ; i <  agencias.size() ; i++){
            Collections.sort(agencias.get(i).getContas(),comparaConta);//Ordena em relacao ao numero da conta
        }
        ...
        ComparadorConta comparaConta2 =new ComparadorConta("CLIENTE");//Compara todos os clientes em relacao ao nome
        for(int  i = 0 ; i <  agencias.size() ; i++){
            if(agencias.get(i).getContas().size() != 0){
               Collections.sort(agencias.get(i).getContas(),comparaConta2);//Ordena em relacao ao nome dos clientes
            }
        }
